...
if ($user) {
    ...
    // 4. アンケート一覧取得で複数件取得とページネーションが動くか確認します。
...
echo '<p>注意: このテストは DB にデータを追加します。不要な場合は手動で戻してください。</p>';
echo '</body></html>';
